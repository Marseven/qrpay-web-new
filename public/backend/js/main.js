...
$('.sidebar-menu-bar').on('click', function (e) {
    e.preventDefault();
    if($('.sidebar, .navbar-wrapper, .body-wrapper, .header, .copyright-wrapper').hasClass('active')) {
      $('.sidebar, .navbar-wrapper, .body-wrapper, .header, .copyright-wrapper').removeClass('active');
      $('.body-overlay').removeClass('show');
    }else {
      $('.sidebar, .navbar-wrapper, .body-wrapper, .header, .copyright-wrapper').addClass('active');
