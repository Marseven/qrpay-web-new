        ...
        <div class="row mb-15-none">
            <div class="col-xxl-6 col-xl-6 col-lg-6 mb-15">
                <div class="chart-wrapper">
                    <div class="chart-area-header">
                        ...
                        <a href="{{ setRoute('admin.add.money.index') }}" class="btn--base modal-btn">
                            {{ __('View') }}</a>
                    </div>
            ...
            <div class="col-lg-6 mb-15">
                <div class="chart-wrapper">
                    <div class="chart-area-header">
                        ...
                        <a href="{{ setRoute('admin.money.out.index') }}" class="btn--base modal-btn">
                            {{ __('View') }}</a>
                    </div>
                    <div class="chart-container">
            ...
            <div class="col-lg-4 mb-15">
                <div class="chart-wrapper">
                    ...
                    <div class="chart-container">
                        <div id="merchants" data-chart_merchant="{{ json_encode($data['chart_merchant']) }}"
                            class="balance-chart"></div>
                    </div>
                    <div class="chart-area-footer">
                        <div class="chart-btn">
                            <a href="{{ setRoute('admin.merchants.index') }}"
                                class="btn--base w-100">{{ __('View Merchants') }}</a>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if ($item->user_id != null)
                                        <a
                                            href="{{ setRoute('admin.users.details', $item->creator->username) }}">{{ $item->creator->fullname }}</a>
                                    @elseif($item->agent_id != null)
                                        <a
                                            href="{{ setRoute('admin.agents.details', $item->creator->username) }}">{{ $item->creator->fullname }}</a>
                                    @endif
