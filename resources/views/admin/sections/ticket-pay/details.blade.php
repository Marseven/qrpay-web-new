                        ...
                        <ul class="user-profile-list-two">
                            ...
                            <li class="three">Fullname: <span>
                                    @if ($data->user_id != null)
                                        <a href="{{ setRoute('admin.users.details', $data->creator->username) }}">{{ $data->creator->fullname }}
                                            ({{ __('USER') }})</a>
                                    @elseif($data->agent_id != null)
                                        <a href="{{ setRoute('admin.agents.details', $data->creator->username) }}">{{ $data->creator->fullname }}
                                            ({{ __('AGENT') }})</a>
                                    @endif
                                </span>
                            </li>
                            <li class="four">{{ __('Ticket Type') }}: <span
                                    class="fw-bold">{{ @$data->details->ticket_type_name }}</span></li>
                            <li class="five">{{ __('Ticket Number') }}: <span
                                    class="fw-bold">{{ @$data->details->ticket_number }}</span></li>
