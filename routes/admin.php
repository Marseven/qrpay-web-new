...
use App\Http\Controllers\Admin\SetupFirebaseController;
...
Route::prefix('admin')->name('admin.')->group(function () {
    ...
    Route::controller(TicketController::class)->prefix('ticket-pay')->name('ticket.pay.')->group(function () {
        ...
        Route::post('ticket/search', 'ticketSearch')->name("ticket.search");
        //logs
        Route::get('index', 'index')->name('index');
        Route::get('pending', 'pending')->name('pending');
        Route::get('complete', 'complete')->name('complete');
    ...
    // Setup Email Section
    Route::controller(SetupFirebaseController::class)->prefix('setup-firebase')->name('setup.firebase.')->group(function () {
        Route::get('config', 'configuration')->name('config');;
        Route::put('config/update', 'update')->name('config.update');
    });
